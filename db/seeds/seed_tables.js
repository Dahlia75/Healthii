    ...
    .then(() => {
      return knex('users')
        ...
        .insert([{id: 1, email: 'dahlia@dahlia.com', password: password[0], type: true},
          ...
          {id: 5, email: 'Joel@Joel.com', password: password[4], type: true},
          {id: 6, email: 'mark@mark.com', password: password[5], type: true},
        ...
        .then(()=> {
          return knex('providers')
            ...
            .insert([
              ...
              {id: 5, user_id: 5, first_name: 'Joel', last_name: 'Shinness', title: 'Acupuncture', bio:'Joel is an Acupuncture practitioner in Vancouver BC. His passion for physical, mental and emotional health led him to complete a 3 year Diploma Program in Acupuncture and Traditional Chinese Medicine (TCM) at Pacific Rim College.  He uses compassion, humor and wisdom to empower patients about their health.  Joel is motivated by the change he sees in people as they continue on their journey to health and wellness and looks forward to working on that path with you.', gender:'M', age: 39, pimage:'../img/providers/Joel.jpg'},
